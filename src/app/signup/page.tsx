...
const formSchema = z.object({
  name1: z.string().min(1, { message: "Your name is required." }),
  name2: z.string().min(1, { message: "Your partner's name is required." }),
...
export default function SignUpPage() {
  ...
  const { user, signUp, signInWithGoogle } = useUser();
