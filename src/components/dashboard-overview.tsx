      ...
      <Card className="mt-8">
          ...
          <CardContent>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <div className="overflow-hidden rounded-lg shadow-md">
                    <Image src="https://placehold.co/300x400.png" alt="Wedding inspiration 4" data-ai-hint="wedding cake" width={300} height={400} className="object-cover aspect-[3/4] hover:scale-105 transition-transform duration-300 ease-in-out" />
                </div>
            </div>
          </CardContent>
      </Card>
